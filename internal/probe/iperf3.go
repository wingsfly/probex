	...
	return ProbeMetadata{
		...
		OutputSchema: &OutputSchema{
			...
			ExtraFields: []ExtraField{
				...
				{Name: "lost_packets", Type: "number", Description: "Lost packets"},
				{Name: "sent_bps", Type: "number", Unit: "bps", Description: "Sent bitrate", DefaultHidden: true},
				{Name: "recv_bps", Type: "number", Unit: "bps", Description: "Received bitrate", DefaultHidden: true},
				{Name: "sent_bytes", Type: "number", Description: "Bytes sent", DefaultHidden: true},
				{Name: "recv_bytes", Type: "number", Description: "Bytes received", DefaultHidden: true},
				{Name: "total_packets", Type: "number", Description: "Total packets", DefaultHidden: true},
				{Name: "duration", Type: "number", Unit: "s", Description: "Test duration", DefaultHidden: true},
				{Name: "streams", Type: "number", Description: "Parallel streams", DefaultHidden: true},
			},
		},
	}
}
